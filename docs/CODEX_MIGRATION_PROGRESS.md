...
- 밴드 세션 지원 상태 endpoint는 웹과 동일하게 `/sessions/applications/submissions`, `/sessions/applications/submissions/{applicationSubmissionId}`, `/users/me/{applySubmissionId}/final`을 사용한다.
...
- `/band/my/applications/[applySubmissionId]`: 밴드 받은 지원 상세
- `/band/session`: 밴드 세션 탭
- `/band/session/applications`: 밴드 세션 내 지원 현황
